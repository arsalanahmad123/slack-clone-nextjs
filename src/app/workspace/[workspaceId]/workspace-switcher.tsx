    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button className="size-9 relative overflow-hidden bg-[#ABABAD] hover:bg-[#ABABAD]/80 text-slate-800 text-lg font-semibold">
                    {workspaceLoading ? (
            ...
            <DropdownMenuContent side="bottom" align="start" className="w-64">
                ...
                {filteredWorkspaces?.map((workspace) => (
                    ...
                    >
                        <div className="size-9 overflow-hidden relative bg-[#616061] text-white font-semibold text-lg rounded-md flex items-center justify-center mr-2 shrink-0">
                            {workspace?.name?.charAt(0).toUpperCase()}
                        </div>
